...
def getvales(*argument):
    print(f"{FirstnameValue.get(),LastNameValue.get(),PhoneNumberValue.get()}")

    with open("details.txt","w") as f:
        f.write(f"{FirstnameValue.get(),LastNameValue.get(),PhoneNumberValue.get()}")
